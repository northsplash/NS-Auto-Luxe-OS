  ...
  return <div className="portal-layout d2d-os nsos-cream">
    ...
    {sidebar&&<div className="sidebar-backdrop" onClick={()=>setSidebar(false)}/>}<main id="portal-workspace" className="portal-main" tabIndex={-1}>
      ...
      <div className="portal-content">
        ...
        {tab==='onboarding'&&<div className="tab-content v2-page"><div className="v2-page-head"><div><span className="eyebrow">NEW HIRE · GUSTO</span><h2>Onboarding packet</h2><p>You fill this in. North Splash stores last-four identifiers only.</p></div></div><EmployeeOnboardingTab employee={employee} onUpdated={setEmployee}/></div>}
        {tab==='territory'&&<div className="tab-content d2d-field-page v2-page">
          <div className="v2-page-head"><div><span className="eyebrow">FIELD · MODELED AFTER SALESRABBIT</span><h2>Work your territory</h2><p>Map, pins, knock colors, and the next door. Tap a house, record the outcome, then go to the next best door.</p></div><div className="v2-head-actions"><button className="btn-outline" onClick={manualLead}><Plus size={15}/> Outside Territory Lead</button><button className="btn-primary" onClick={nextBest}><Target size={15}/> Next Best House</button></div></div>
