...
export default function EnterpriseSuite({ section, employees, setEmployees, appointments, setAppointments }: Props) {
  ...
  if (section === 'job_assignments') {
    ...
    return <div className="tab-content v19-job-assignment"><Header title="Job Assignment" subtitle="Assign detailers, managers and originating D2D reps from one clean dispatch workspace." />
