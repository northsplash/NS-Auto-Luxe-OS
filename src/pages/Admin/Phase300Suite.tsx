...
import {
  ...
  GraduationCap, MapPinned, MapPin, Pause, Pencil, Play, Plus, Route,
  Save, Search, ShieldAlert, Target, Trash2, UserCheck, Users, XCircle,
  Eye, Receipt, RefreshCw, MessageSquare, UserRound
} from 'lucide-react';
...
export default function Phase300Suite({section,employees,appointments,setAppointments,customers,payments,onNavigate,ownerName}:Props){
  ...
  if(section==='communications') return <CommunicationsCenter Header={Header}/>;
