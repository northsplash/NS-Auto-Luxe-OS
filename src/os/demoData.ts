...
export const seedLeads: Array<Partial<OsLead> & { id: string; name: string; address: string }> = [
  ...
  { id: 'l9', name: 'Unknown door', address: '102 Tryon St, Charlotte NC 28202', status: 'follow_up', rep: 'Sofia Reyes', value: 275, temp: 'warm', phone: '919-555-1009', follow_up_at: windowOn(-1, '6:00 PM'), x: 28, y: 46, notes: 'Callback last night after dinner. Still open.', activity: [] },
  ...
  { id: 'l11', name: 'Unknown door', address: '214 Ninth St, Durham NC 27705', status: 'unworked', rep: 'Sofia Reyes', value: 175, temp: 'cold', phone: '', x: 24, y: 30, notes: '', activity: [] },
  { id: 'l12', name: 'Unknown door', address: '218 Ninth St, Durham NC 27705', status: 'no_answer', rep: 'Sofia Reyes', value: 175, temp: 'warm', phone: '', x: 26, y: 32, notes: 'Hanger left.', activity: [] },
  { id: 'l13', name: 'The Bells', address: '222 Ninth St, Durham NC 27705', status: 'unworked', rep: 'Unassigned', value: 275, temp: 'cold', phone: '919-555-1013', x: 20, y: 34, notes: '', activity: [] },
  { id: 'l14', name: 'Unknown door', address: '16 Oleander Dr, Wilmington NC 28403', status: 'unworked', rep: 'Unassigned', value: 275, temp: 'cold', phone: '', x: 82, y: 44, notes: '', activity: [] },
  { id: 'l15', name: 'Unknown door', address: '20 Oleander Dr, Wilmington NC 28403', status: 'revisit', rep: 'Sofia Reyes', value: 275, temp: 'warm', phone: '919-555-1015', follow_up_at: windowOn(0, '5:30 PM'), x: 78, y: 40, notes: 'Come back after work.', activity: [] },
];
