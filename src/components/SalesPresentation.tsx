        ...
        {accountSuccess || <>
          <section className="sales-quote-builder">
            <div className="sales-slide-heading">
              ...
              <p>Capture the household, then create a customer login they can use after you leave. Name and phone save a lead. Email plus a password opens the portal.</p>
            </div>
